				...
				<section class="content">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Hasil Perhitungan Pagu Global (Jurusan)</h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
							...
							<?php if ($anggaran['isApproval'] == 1 && $this->session->userdata('akses') == 2) : ?>
								<a class="btn btn-success btn-sm" href="<?= base_url('edit-simulasi-jurusan/' . $anggaran['id_simulasi']) ?>"><i class="fa fa-edit"></i> Edit</a>
							<?php endif; ?>
									...
									<?php if ($tabel_hasil != NULL) {
										foreach ($tabel_hasil as $key => $value) {
											if ($value->id_kriteria == 1) {
												echo '<tr style="background-color:#d2d6de;">';
											} else {
												echo '<tr style="background-color:#00c0ef;">';
											}
									?>
						...
						<div class="box-footer">
							<a href="<?php echo base_url('export-simulasi-jurusan/' . $anggaran['id_simulasi']) ?>"><button type="button" id="simpan_paJurusan" class="btn btn-info" tabindex="11"><span class="fa fa-download"></span> Export Excel </button></a>
							...
							<?php if ($this->session->userdata('akses') == 1) : ?>
								<?php if ($anggaran['isApproval'] == 0 || $anggaran['isApproval'] == 1) : ?>
									<a class="btn btn-success" href="<?= base_url('Pagu_jurusan/validasiData/' . $anggaran['id_simulasi']) ?>"><i class="fa fa-check-square"></i> Validasi</a>
								<?php endif; ?>
